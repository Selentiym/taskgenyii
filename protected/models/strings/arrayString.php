...
class arrayString {
    const stops = array("возле","около","у","в","для", "на", "по", "со", "из", "от", "до", "без", "над", "под", "за", "при", "после", "во","у",
